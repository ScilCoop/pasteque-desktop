    ...
    public void loadCatalog() throws BasicException {
        ...
        for (SubgroupInfo s: subgroups) {
            ...
            for (ProductInfoExt prod : products) {
                m_jCurrTab.addButton(new ImageIcon(
                        tnbbutton.getThumbNailText(prod.getImage(),
                        getProductLabel(prod))),
                        prod.getID(), new SelectedAction(prod));
            }
        }
 ...
 */
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(m_jbtnSaveSubgroup)
                        .addGap(1, 1, 1)
                        .addComponent(m_jbtnDelSubgroup))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(m_jLittleImageEditor, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)))
                    .addComponent(m_jbtnNewSubgroup, GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel5Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(m_jbtnSaveSubgroup, GroupLayout.PREFERRED_SIZE, 28, Short.MAX_VALUE)
                    .addComponent(m_jbtnDelSubgroup, GroupLayout.PREFERRED_SIZE, 28, Short.MAX_VALUE))
                .addGap(8, 8, 8))
        );
                ...
                .addGroup(m_jAddProductsLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addGroup(GroupLayout.Alignment.TRAILING, m_jAddProductsLayout.createSequentialGroup()
                        .addGroup(m_jAddProductsLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                            .addComponent(jLabel6, GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE)
                            .addComponent(jLabel5, GroupLayout.DEFAULT_SIZE, 59, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(m_jAddProductsLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                            .addComponent(m_jCategory, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(m_jProduct, 0, 206, Short.MAX_VALUE)))
                    .addGroup(GroupLayout.Alignment.LEADING, m_jAddProductsLayout.createSequentialGroup()
                        //.addContainerGap(190, Short.MAX_VALUE)
                        .addComponent(m_jbtnAddProduct)
                        .addGap(1, 1, 1)
                        .addComponent(m_jbtnDelProduct, GroupLayout.PREFERRED_SIZE, 43, GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        m_jAddProductsLayout.setVerticalGroup(
            ...
            .addGroup(m_jAddProductsLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(m_jAddProductsLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(m_jAddProductsLayout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                    .addComponent(m_jbtnAddProduct, GroupLayout.PREFERRED_SIZE, 28, Short.MAX_VALUE)
