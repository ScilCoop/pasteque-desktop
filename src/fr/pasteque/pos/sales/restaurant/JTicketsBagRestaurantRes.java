...
import fr.pasteque.data.gui.*;
import fr.pasteque.data.loader.*;
import fr.pasteque.data.user.*;
...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        m_jtxtDescription = new fr.pasteque.pos.widgets.JEditorString();
        m_jtxtChairs = new fr.pasteque.pos.widgets.JEditorIntegerPositive();
        txtCustomer = new fr.pasteque.pos.widgets.JEditorString();
    ...
    private fr.pasteque.pos.widgets.JEditorIntegerPositive m_jtxtChairs;
    private fr.pasteque.pos.widgets.JEditorString m_jtxtDescription;
    private fr.pasteque.pos.widgets.JEditorString txtCustomer;
