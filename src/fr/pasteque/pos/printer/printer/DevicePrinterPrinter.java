...
package fr.pasteque.pos.printer.printer;
...
import fr.pasteque.pos.printer.ticket.BasicTicket;
import fr.pasteque.pos.printer.ticket.BasicTicketForPrinter;
import fr.pasteque.pos.util.ReportUtils;
import fr.pasteque.pos.util.SelectPrinter;
 ...
 * class PrintableTicket @see fr.pasteque.pos.printer.printer.PrintableTicket
 *  
 * @author jaroslawwozniak
 */
public class DevicePrinterPrinter implements DevicePrinter {

    private static Logger logger = Logger.getLogger("fr.pasteque.pos.printer.printer.DevicePrinterPrinter");
