...
public class PaymentsEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    public PaymentsEditor(AppView oApp, DirtyManager dirty) {
        ...
        jNotes.getDocument().addDocumentListener(dirty);
    ...
    public Object createValue() throws BasicException {
        ...
        payment[6] = m_sNotes == null ? "" : m_sNotes;
        CurrencyInfo currency = dlSales.getMainCurrency();
        payment[7] = currency.getID();
        return payment;
    }
    ...
    private void initComponents() {
        ...
        jTotal = new fr.pasteque.pos.widgets.JEditorCurrency();
        jPanel2 = new javax.swing.JPanel();
        m_jKeys = new fr.pasteque.pos.widgets.JEditorKeys();
        javax.swing.JLabel notesLabel = new javax.swing.JLabel();
        ...
        notesLabel.setText(AppLocal.getIntString("Label.Notes"));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jNotes, javax.swing.GroupLayout.PREFERRED_SIZE, 234, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private fr.pasteque.pos.widgets.JEditorCurrency jTotal;
