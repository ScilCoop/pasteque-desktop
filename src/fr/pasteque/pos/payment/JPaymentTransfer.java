...
public class JPaymentTransfer extends javax.swing.JPanel implements JPaymentInterface {
    ...
    public JPaymentTransfer(JPaymentNotifier notifier) {
        m_notifier = notifier;
    ...
    public PaymentInfo executePayment() {
        return new PaymentInfoTicket(m_dPaid, this.currency, "transfer");
    }
